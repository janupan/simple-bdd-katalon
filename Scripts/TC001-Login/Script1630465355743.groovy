...
WebUI.setText(findTestObject('Object Repository/Page_Login to LeadManager/input_Welcome back_username'), 'telkom_dbs')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login to LeadManager/input_Welcome back_password'), 'MG0ylDrJ4ns=')
